...
*****************************************************************************/
/*****************************************************************************
* This file declares the functions provided by the ble_application.c 
* source file
*******************************************************************************/
...
/* Function that processes BLE events and restarts advertisement 
   if required */
void ProcessBleEvents(void);

/* Function that restarts BLE advertisement after a timeout or a
   disconnect event */
void RestartBleAvertisement (void);

/* Function that requests to read current temperature and send BLE indication
   if enabled */
