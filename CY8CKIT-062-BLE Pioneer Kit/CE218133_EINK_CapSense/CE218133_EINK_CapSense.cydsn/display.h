...
* Version: 1.10
*
* Description: This file declares the macros, types and functions provided by the
*              display.c file
*
...
*******************************************************************************/
/******************************************************************************
* This file declares the macros, types and functions provided by the 
* display_interface.c file
*******************************************************************************/
...
/* Define "image" as the E-INK image type */
typedef cy_eink_image_t image;   
